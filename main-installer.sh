...
# Version: 1.0.10.ub1404lts "Leopardus Pardalis"
# February 27, 2016
#
...
"install")
	...
	echo "Flavor: OpenStack KILO for Ubuntu 14.04lts"
	echo "Made by: Reynaldo R. Martinez P."
	echo "E-Mail: TigerLinux@Gmail.com"
	echo "Version 1.0.10.ub1404lts \"Leopardus Pardalis\" - February 27, 2016"
	echo ""
	...
	echo "- Ubuntu Cloud Archive OpenStack-KILO repository must be enabled and available"
